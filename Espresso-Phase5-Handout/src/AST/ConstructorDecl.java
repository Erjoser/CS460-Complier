...
public class ConstructorDecl extends ClassBodyDecl  {
    /**
     * The symbol table opened for a constructor declarations parameters and one for 
     * the body.
     */
    public SymbolTable mySymbolTableParams = null;
    public SymbolTable mySymbolTableBody = null;
