...
public class WriteFiles {
	...
	System.out.println("Writing " + (writeOptimized ? "Optimized" : "Unoptimized") + " jasmin file : '" + outputFileName + "'");
	try {
    ...
    private static void writeVars(java.io.PrintWriter out, ClassBodyDecl cd) {
	if (Utilities.Settings.generateVars) {	    
	    for (int i = 0; i < cd.vars.size(); i++) {
		out.println("\t"+cd.vars.get(i));
