...
public class Settings {
    ...
    /** Determines if the compiler should generate .var lines.
     * A var line has the following syntax:<br>
     * <tt>.var <var_number> is <var_name> <descriptor> [signature <sign>] from <label1> to <label2></tt>
     */
    public static boolean generateVars = false;
    
    public static boolean writeCommentsInJasminFile = true;
}
